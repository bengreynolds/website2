    ...
    >
      <div className="deck-panel-inner">
        ...
        <div className="deck-figure">
          ...
          {/* The brand marks came from the accordion layout this deck
              replaced. They are content rather than layout - the tools a
              competence is worked in - so they survive the change of section
              and ride along in the figure column, deduplicated across the
              whole panel's readout. A panel naming no products renders none,
              which is most of the reason this is safe to keep here. */}
